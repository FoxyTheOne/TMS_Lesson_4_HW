...
/**
 * Все методы реализовать в отдельном классе в статических методах, которые на вход(входным параметром) будут
...
public class DocumentCheck {
    ...
    public static void findABC(String invoiceNumber) {
        ...
        if (abcLocation >= 0) {
            ...
            System.out.println("Строка не содержит последовательность \"abc\"");
        }
    }

    // Проверить начинается ли номер документа с последовательности 555.
    public static void ifBeginsWith555(String invoiceNumber) {
    ...
    public static void ifEndsWith1a2b(String invoiceNumber) {
